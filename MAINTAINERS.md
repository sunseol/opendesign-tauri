...
a Maintainer of `sunseol/opendesign-tauri`. The Core Team's individual roster is
...
- **>= 20 merged PRs** to `sunseol/opendesign-tauri`.
...
While `sunseol/opendesign-tauri` is younger than six months from initial commit,
