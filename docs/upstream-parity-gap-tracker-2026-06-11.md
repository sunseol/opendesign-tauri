...
| Desktop and packaged runtime | `apps/desktop` 34 files, `apps/packaged` 28 files | [#14](https://github.com/sunseol/opendesign-tauri/issues/14), [#27](https://github.com/sunseol/opendesign-tauri/issues/27), [#37](https://github.com/sunseol/opendesign-tauri/issues/37), [#50](https://github.com/sunseol/opendesign-tauri/issues/50) | In progress - runtime helper package closure guarded for Tauri packaging, packaged host OS locale detection, app version release-channel inference, and updater control visibility lifecycle covered |
...
- Daemon runtime #7 now stages Grok Build prompts through daemon-owned temp
  ...
  media policy denial/example payloads. Broader sandbox resume, registry, and
