...
- Design-system catalog #34 now has 150 migrated project manifests, derived
  ...
  and `od design-systems` help/rename/import-shadcn CLI coverage. Interactive
  edit/pin/switch behavior remains tracked under #35.
