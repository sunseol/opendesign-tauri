...
- Daemon runtime #7 now stages Grok Build prompts through daemon-owned temp
  ...
  watchdog room without overriding operator env settings. Broader sandbox
  resume, registry, and route parity remains open under #7/#33/#48.
