...
describe('createPackagedDesktopLogger log append failures', () => {
  it('returns false when a desktop log append fails', () => {
  ...
  it('does not throw when logger or console writes cannot append', () => {
