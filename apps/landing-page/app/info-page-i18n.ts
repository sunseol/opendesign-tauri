      ...
      lovable: {
        ...
        rich: {
          ...
          heroCtaActions: [
            ...
            { label: 'Download the desktop app', href: 'https://github.com/sunseol/opendesign-tauri/releases', variant: 'ghost', external: true },
          ],
          heroImage: {
