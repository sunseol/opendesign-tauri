...
export const zhCN: Dict = {
  ...
  'settings.amrSignInToContinue': '登录以继续',
  'settings.amrSigningIn': '正在登录…',
  'settings.amrCancelSignIn': '取消登录',
  'settings.amrLoginErrorCompact': 'AMR 登录失败。',
  'settings.onboardingAmrCloudBenefitOfficial': '官方推荐',
  'settings.onboardingAmrCloudBenefitReady': '无需部署',
  'settings.onboardingAmrCloudBenefitModels': '支持 Claude Opus 4.8',
  'settings.onboardingAmrCloudBenefitPricing': 'SOTA 评测套件',
  'settings.onboardingAmrCloudUpcomingLabel': '即将推出',
  'settings.onboardingAmrCloudUpcomingImageVideo': '图片与视频',
  ...
  'settings.cliEnvClaudeBaseUrl': 'Claude 代理基础 URL',
  'settings.cliEnvClaudeApiKey': 'Claude 代理 API 密钥',
  'settings.cliEnvCodexHome': 'Codex 主目录',
  'settings.cliEnvCodexBin': 'Codex 可执行文件路径',
  'settings.cliEnvCodexBaseUrl': 'Codex/OpenAI 代理基础 URL',
  'settings.cliEnvCodexApiKey': 'Codex/OpenAI 代理 API 密钥',
  ...
  'settings.mediaProviderApiKey': 'API 密钥',
  'settings.mediaProviderBaseUrl': '基础 URL',
  ...
  'chat.amrError.authMessage': '需要登录 AMR。请先登录 AMR Cloud，然后重试本次运行。',
  'chat.amrError.balanceMessage': 'AMR Cloud 提示此模型余额不足。请先充值 AMR 钱包，然后重试本次运行。',
  'chat.amrError.authorizeCta': '登录 AMR',
  'chat.amrError.rechargeCta': '充值 AMR',
  ...
  'designFiles.newFolder': '新建文件夹',
  'designFiles.folderName': '文件夹名称',
  'designFiles.createFolder': '创建文件夹',
  'designFiles.deleteFolder': '删除文件夹',
  'designFiles.deleteFolderAria': '删除文件夹 {path}',
  'designFiles.deleteFolderConfirm': '要删除文件夹“{path}”吗？',
  'designFiles.deleteFolderFailed': '无法删除文件夹“{path}”。',
  ...
  'fileViewer.deploySuccessToast': '部署上传成功',
