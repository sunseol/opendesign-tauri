...
export const esES: Dict = {
  ...
  'designFiles.newFolder': 'Nueva carpeta',
  'designFiles.folderName': 'Nombre de carpeta',
  'designFiles.createFolder': 'Crear carpeta',
  'designFiles.deleteFolder': 'Eliminar carpeta',
  'designFiles.deleteFolderAria': 'Eliminar carpeta {path}',
  'designFiles.deleteFolderConfirm': '¿Eliminar la carpeta "{path}"?',
  'designFiles.deleteFolderFailed': 'No se pudo eliminar la carpeta "{path}".',
  ...
  'settings.apiKeyGetLink': 'Obtener clave en {host} ↗',
