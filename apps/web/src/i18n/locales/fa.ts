...
export const fa: Dict = {
  ...
  'designFiles.newFolder': 'پوشه جدید',
  'designFiles.folderName': 'نام پوشه',
  'designFiles.createFolder': 'ایجاد پوشه',
  'designFiles.deleteFolder': 'حذف پوشه',
  'designFiles.deleteFolderAria': 'حذف پوشه {path}',
  'designFiles.deleteFolderConfirm': 'پوشه "{path}" حذف شود؟',
  'designFiles.deleteFolderFailed': 'امکان حذف پوشه "{path}" نبود.',
  ...
  'settings.apiKeyGetLink': 'دریافت کلید در {host} ↗',
