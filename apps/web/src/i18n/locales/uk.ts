...
export const uk: Dict = {
  ...
  'designFiles.sectionFolders': 'Теки',
  'designFiles.kindFolder': 'Тека',
  'designFiles.newFolder': 'Нова тека',
  'designFiles.folderName': 'Назва теки',
  'designFiles.createFolder': 'Створити теку',
  'designFiles.deleteFolder': 'Видалити теку',
  'designFiles.deleteFolderAria': 'Видалити теку {path}',
  'designFiles.deleteFolderConfirm': 'Видалити теку "{path}"?',
  'designFiles.deleteFolderFailed': 'Не вдалося видалити теку "{path}".',
  ...
  'settings.apiKeyGetLink': 'Отримати ключ на {host} ↗',
