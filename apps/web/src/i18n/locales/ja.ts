...
export const ja: Dict = {
  ...
  'designFiles.kindFolder': 'フォルダー',
  'designFiles.newFolder': '新しいフォルダー',
  'designFiles.folderName': 'フォルダー名',
  'designFiles.createFolder': 'フォルダーを作成',
  'designFiles.deleteFolder': 'フォルダーを削除',
  'designFiles.deleteFolderAria': 'フォルダー {path} を削除',
  'designFiles.deleteFolderConfirm': 'フォルダー「{path}」を削除しますか？',
  'designFiles.deleteFolderFailed': 'フォルダー「{path}」を削除できませんでした。',
  ...
  'settings.apiKeyGetLink': '{host} でキーを取得 ↗',
