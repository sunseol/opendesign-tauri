...
export const ko: Dict = {
  ...
  'chat.resumeRunCta': '이 실행 이어가기',
  'chat.amrError.authMessage': 'AMR 로그인이 필요합니다. AMR Cloud에 다시 로그인한 뒤 이 실행을 다시 시도하세요.',
  'chat.amrError.balanceMessage': 'AMR Cloud에서 이 모델을 실행할 잔액이 부족하다고 응답했습니다. AMR 지갑을 충전한 뒤 다시 시도하세요.',
  'chat.amrError.authorizeCta': 'AMR 로그인',
  ...
  'designFiles.newFolder': '새 폴더',
  'designFiles.folderName': '폴더 이름',
  'designFiles.createFolder': '폴더 만들기',
  'designFiles.deleteFolder': '폴더 삭제',
  'designFiles.deleteFolderAria': '{path} 폴더 삭제',
  'designFiles.deleteFolderConfirm': '"{path}" 폴더를 삭제할까요?',
  'designFiles.deleteFolderFailed': '"{path}" 폴더를 삭제하지 못했습니다.',
  ...
  'settings.apiKeyGetLink': '{host}에서 키 받기 ↗',
