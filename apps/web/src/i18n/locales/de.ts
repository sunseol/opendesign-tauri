...
export const de: Dict = {
  ...
  'designFiles.newFolder': 'Neuer Ordner',
  'designFiles.folderName': 'Ordnername',
  'designFiles.createFolder': 'Ordner erstellen',
  'designFiles.deleteFolder': 'Ordner löschen',
  'designFiles.deleteFolderAria': 'Ordner {path} löschen',
  'designFiles.deleteFolderConfirm': 'Ordner "{path}" löschen?',
  'designFiles.deleteFolderFailed': 'Ordner "{path}" konnte nicht gelöscht werden.',
  ...
  'settings.apiKeyGetLink': 'Key bei {host} abrufen ↗',
