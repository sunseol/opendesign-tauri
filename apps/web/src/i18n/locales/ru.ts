...
export const ru: Dict = {
  ...
  'designFiles.newFolder': 'Новая папка',
  'designFiles.folderName': 'Имя папки',
  'designFiles.createFolder': 'Создать папку',
  'designFiles.deleteFolder': 'Удалить папку',
  'designFiles.deleteFolderAria': 'Удалить папку {path}',
  'designFiles.deleteFolderConfirm': 'Удалить папку "{path}"?',
  'designFiles.deleteFolderFailed': 'Не удалось удалить папку "{path}".',
  ...
  'settings.apiKeyGetLink': 'Получить ключ на {host} ↗',
