...
export const en: Dict = {
  ...
  'designFiles.folderName': 'Folder name',
  'designFiles.createFolder': 'Create folder',
  'designFiles.deleteFolder': 'Delete folder',
  'designFiles.deleteFolderAria': 'Delete folder {path}',
  'designFiles.deleteFolderConfirm': 'Delete folder "{path}"?',
  'designFiles.deleteFolderFailed': 'Could not delete folder "{path}".',
