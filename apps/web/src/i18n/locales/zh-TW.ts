...
export const zhTW: Dict = {
  ...
  'pluginsHome.subtitle':
    '此執行環境內建的即用 Open Design 工作流程。選擇一個以載入起始提示詞，或瀏覽外掛登錄檔取得更多。',
  'pluginsHome.browseRegistry': '瀏覽外掛登錄檔',
  'pluginsHome.count': '{filtered} / {total}',
  'pluginsHome.loadingCatalog': '正在載入目錄…',
  'pluginsHome.emptyCatalog':
    '目錄是空的。內建外掛會隨 Open Design 提供，應會自動顯示在這裡 — 如果持續發生，請重新啟動常駐程式。',
  'pluginsHome.emptyFiltered': '沒有符合目前篩選條件的外掛。',
  'pluginsHome.clearFilters': '清除篩選',
  'pluginsHome.modeAria': '外掛模式',
  'pluginsHome.featured': '已儲存',
  'pluginsHome.totalInCatalog': '目錄中有 {n} 個',
  ...
  'pluginsHome.facet.screenshot': '螢幕截圖',
  ...
  'pluginsView.lede': '瀏覽已安裝的工作流程、探索登錄檔項目、管理來源，並準備外掛供團隊發佈。',
  'pluginsView.importPlugin': '匯入外掛',
  'pluginsView.agentContext': '代理上下文',
  'pluginsView.summaryAria': '外掛摘要',
  'pluginsView.areasAria': '外掛區域',
  ...
  'pluginsView.tabHint.installed': '你的外掛',
  'pluginsView.tabHint.available': '來自來源',
  'pluginsView.tabHint.sources': '目錄',
  'pluginsView.tabHint.team': '企業',
  'pluginsView.installedTitle': '已安裝外掛',
  'pluginsView.installedSubtitle': '你從市集來源匯入或安裝的外掛。',
  'pluginsView.installedEmpty': '尚無已安裝的使用者外掛。請使用「建立 / 匯入」或安裝「可用」項目。',
  'pluginsView.availableTitle': '來源中的可用項目',
  'pluginsView.availableSubtitle': '從已設定市集探索到的目錄項目。',
  'pluginsView.availableFiltersAria': '可用外掛篩選',
  'pluginsView.searchAvailableAria': '搜尋可用外掛',
  'pluginsView.searchAvailablePlaceholder': '搜尋可用外掛',
  'pluginsView.clearAvailableSearch': '清除可用外掛搜尋',
  'pluginsView.source': '來源',
  'pluginsView.availableEmptyInstalled':
    '尚無可用項目。已安裝的目錄項目會從「可用」移除；解除安裝後會再次可用。',
  'pluginsView.availableEmptyFiltered': '沒有符合篩選條件的可用項目。',
  'pluginsView.availableEmptyNoSources': '尚無可用項目。請在「來源」分頁新增來源。',
  'pluginsView.installing': '安裝中…',
  'pluginsView.install': '安裝',
  'pluginsView.sourcesTitle': '登錄檔來源',
  'pluginsView.sourcesSubtitle': '提供「可用」外掛項目的市集目錄。',
  'pluginsView.sourceUrl': '來源 URL',
  'pluginsView.defaultTrust': '預設信任等級',
  ...
  'pluginsView.sourcesEmpty': '尚未設定登錄檔來源。',
  'pluginsView.pluginsCount': '{n} 個外掛',
  'pluginsView.catalogVersion': '目錄 v{version}',
  'pluginsView.trustFor': '{name} 的信任等級',
  'pluginsView.refreshing': '重新整理中…',
  'pluginsView.removing': '移除中…',
  'pluginsView.teamTitle': '私有團隊市集',
  'pluginsView.teamBody': '此區保留給企業和團隊目錄、私有信任政策，以及共享外掛生命週期控制。',
  ...
  'plugins.availableDetails.copyInstallCommand': '複製安裝命令',
  'plugins.availableDetails.copied': '已複製',
  'plugins.availableDetails.deprecatedPrefix': '已棄用：{message}',
  'plugins.availableDetails.deprecatedFallback': '此版本已標記為棄用。',
  'plugins.availableDetails.yanked': '已撤回。',
  'plugins.availableDetails.yankedWithReason': '已撤回：{reason}',
  'plugins.availableDetails.versionDeprecatedSuffix': '（已棄用）',
  ...
  'homeHero.title': '想設計什麼？',
  'homeHero.subtitlePrefix': '描述你想生成的內容，然後按',
  'homeHero.toRun': '以執行',
  'homeHero.forNewLine': '換行',
  'homeHero.placeholder': '描述你想生成的內容…',
  'homeHero.placeholderActive': '編輯範例查詢，或寫下你自己的內容…',
  'homeHero.typeSomethingToRun': '輸入內容即可執行',
  'homeHero.run': '執行',
  'homeHero.applying': '套用中…',
  'homeHero.chip.audio': '音訊',
  'homeHero.chip.createPlugin': '建立外掛',
  'homeHero.chip.createPluginHint': '建立可重複使用的 Open Design 外掛，並加入「我的外掛」。',
  'homeHero.chip.deck': '簡報',
  'homeHero.chip.figma': '從 Figma',
  'homeHero.chip.figmaHint': '將 Figma 畫框移轉到目前的設計系統。',
  'homeHero.chip.folder': '從資料夾',
  'homeHero.chip.folderHint': '匯入既有本機資料夾並繼續編輯。',
  'homeHero.chip.hyperframes': 'HyperFrames',
  'homeHero.chip.hyperframesHint': '建立 HTML 動態內容：字幕、音訊反應視覺和場景轉場。',
  'homeHero.chip.image': '圖片',
  'homeHero.chip.liveArtifact': '即時成品',
  'homeHero.chip.liveArtifactHint': '建立可即時預覽的互動式 HTML/CSS/JS 成品。',
  'homeHero.chip.prototype': '原型',
  'homeHero.chip.template': '從範本',
  'homeHero.chip.templateHint': '從內建範本開始。',
  'homeHero.chip.video': '影片',
  'homeHero.clearActivePlugin': '清除作用中外掛',
  'homeHero.clearActiveSkill': '清除作用中技能',
  'homeHero.confirmReplace': '替換',
  'homeHero.confirmReplaceBody': '使用 {title} 會替換輸入框中的目前文字。',
  'homeHero.confirmReplaceTitle': '要替換目前的提示詞嗎？',
  'homeHero.contextItemsResolved': '已解析 {n} 個上下文項目',
  'homeHero.contextSearchResults': '上下文搜尋結果',
  'homeHero.contextSurfaces': '上下文來源',
  'homeHero.details': '詳細資訊',
  ...
  'settings.amrSignInToContinue': '登入以繼續',
  'settings.amrSigningIn': '正在登入…',
  'settings.amrCancelSignIn': '取消登入',
  'settings.amrLoginErrorCompact': 'AMR 登入失敗。',
  'settings.onboardingAmrCloudBenefitOfficial': '官方推薦',
  'settings.onboardingAmrCloudBenefitReady': '無需部署',
  'settings.onboardingAmrCloudBenefitModels': '支援 Claude Opus 4.8',
  'settings.onboardingAmrCloudBenefitPricing': 'SOTA 評測套件',
  'settings.onboardingAmrCloudUpcomingLabel': '即將推出',
  'settings.onboardingAmrCloudUpcomingImageVideo': '圖片與影片',
  'settings.onboardingAmrCloudUpcomingSkills': '海量技能',
  ...
  'settings.testRetry': '重新測試',
  'settings.required': '必填',
  'settings.testMissingFields': '請先填寫 {fields}，再測試連線。',
  ...
  'settings.cliEnvClaudeBaseUrl': 'Claude 代理基礎 URL',
  'settings.cliEnvClaudeApiKey': 'Claude 代理 API 金鑰',
  'settings.cliEnvCodexHome': 'Codex 主目錄',
  'settings.cliEnvCodexBin': 'Codex 可執行檔路徑',
  'settings.cliEnvCodexBaseUrl': 'Codex/OpenAI 代理基礎 URL',
  'settings.cliEnvCodexApiKey': 'Codex/OpenAI 代理 API 金鑰',
  ...
  'settings.mediaProviderApiKey': 'API 金鑰',
  'settings.mediaProviderBaseUrl': '基礎 URL',
  ...
  'tasks.lede':
    '自動化會把提示詞變成可持續運行的工作：Orbit 負責執行，例程保留工作，排程決定觸發時間，即時成品則呈現變化。',
  'tasks.newAutomation': '新增自動化',
  'tasks.previewNote':
    '目前僅為預覽介面。Orbit 設定已可用；例程、排程與即時成品接線會在後端分支合併後上線。',
  'tasks.primitivesAria': '自動化基礎能力',
  'tasks.primitive.orbit.title': 'Orbit',
  'tasks.primitive.orbit.body': '用於長時間或週期性代理工作的持久執行環境。',
  'tasks.primitive.orbit.enabled': '每日摘要已啟用',
  'tasks.primitive.orbit.manualOnly': '僅手動',
  'tasks.primitive.routines.title': '例程',
  'tasks.primitive.routines.body': '單次對話結束後仍會保留的持久任務定義。',
  'tasks.primitive.routines.meta': '產品外殼已就緒',
  'tasks.primitive.schedules.title': '排程',
  'tasks.primitive.schedules.body': '以時間或事件觸發，決定例程何時執行。',
  'tasks.primitive.schedules.meta': '分支待合併',
  'tasks.primitive.liveArtifacts.title': '即時成品',
  'tasks.primitive.liveArtifacts.body': '代理工作時持續更新的報告與筆記。',
  'tasks.primitive.liveArtifacts.meta': '預覽模型',
  'tasks.listAria': '自動化列表',
  'tasks.routinesAndRuns': '{n} 個例程與執行',
  ...
  'tasks.slot.trigger': '觸發器',
  'tasks.slot.pattern': '模式',
  'tasks.slot.runtime': '執行環境',
  'tasks.slot.output': '輸出',
  'tasks.liveArtifact': '即時成品',
  'tasks.viewProgress': '查看進度',
  'tasks.pause': '暫停',
  'tasks.runNow': '立即執行',
  'tasks.openArtifact': '開啟成品',
  'tasks.status.dailyAt': '每日 · {time}',
  'tasks.status.pausedManual': '已暫停 · 僅手動',
  'tasks.sample.orbit.title': 'Orbit 每日連接器摘要',
  'tasks.sample.orbit.metaEnabled': '連接器摘要已排程',
  'tasks.sample.orbit.metaDisabled': '開啟 Orbit 設定以啟用',
  'tasks.sample.orbit.previewEnabled': 'orbit_daily.html · 即時成品',
  'tasks.sample.orbit.previewDisabled': '尚未排程執行',
  'tasks.sample.orbit.triggerEnabled': '排程 · 每日 {time}',
  'tasks.sample.orbit.triggerDisabled': '手動 · 按需執行',
  'tasks.sample.orbit.pattern': '例程 · 連接器摘要',
  'tasks.sample.orbit.runtime': 'Orbit · daemon 已排程',
  'tasks.sample.orbit.output': '即時成品 · 可重新整理的報告',
  'tasks.sample.orbit.artifactMetaEnabled': '每次執行後重新整理',
  'tasks.sample.orbit.artifactMetaDisabled': '等待排程',
  'tasks.sample.orbit.body1': '# Orbit 每日活動摘要',
  'tasks.sample.orbit.body2': '已檢查連接器 · 成功、略過與失敗',
  'tasks.sample.orbit.body3': '重點會成為可重新整理的即時成品。',
  'tasks.sample.mcp.title': 'MCP 替代方案研究',
  'tasks.sample.mcp.status': '在 Orbit 中執行 · 2 小時 14 分',
  'tasks.sample.mcp.meta': '已處理 14 / 30 個來源',
  'tasks.sample.mcp.preview': 'research_notes.md · 即時',
  'tasks.sample.mcp.trigger': '手動 · 一次性',
  'tasks.sample.mcp.pattern': '深度研究提示詞',
  'tasks.sample.mcp.runtime': '遠端 · 持久',
  'tasks.sample.mcp.output': '即時報告 · 自動更新',
  'tasks.sample.mcp.artifactMeta': '12 秒前更新',
  'tasks.sample.mcp.body1': '# MCP 替代方案 - 中期發現',
  'tasks.sample.mcp.body2': '已審閱 14 個來源 · 入選 3 個候選方案',
  'tasks.sample.mcp.body3': '## 入選清單',
  'tasks.sample.mcp.body4': '- 透過 JSON-RPC 的工具呼叫結構描述...',
  'tasks.sample.mcp.body5': '- 基於 gRPC 的代理通訊協定...',
  'tasks.sample.weekly.title': '每週團隊摘要',
  'tasks.sample.weekly.status': '下一次：週一上午 9:00',
  'tasks.sample.weekly.meta': '更新 Team 每週文件',
  'tasks.sample.weekly.preview': 'team_weekly.md · 下一個成品',
  'tasks.sample.weekly.trigger': '排程 · 每週',
  'tasks.sample.weekly.pattern': '例程 · 團隊摘要',
  'tasks.sample.weekly.runtime': '遠端 · 週期性',
  'tasks.sample.weekly.output': '即時成品 · Markdown',
  'tasks.sample.weekly.artifactMeta': '4 天前最後更新',
  'tasks.sample.weekly.body1': '# 團隊週報',
  'tasks.sample.weekly.body2': '## 進行中',
  'tasks.sample.weekly.body3': '- 設計系統整合檢查',
  'tasks.sample.weekly.body4': '- 連接器品質盤點',
  ...
  'tasks.sample.pr.artifactMeta': '23 分鐘前最後觸發',
  'tasks.sample.pr.body1': '已開啟 PR #184 等待審查',
  'tasks.sample.pr.body2': '指派審查者：design-platform、web-runtime',
  'tasks.sample.pr.body3': '傳送狀態：Slack 私訊已送出',
  'tasks.sample.meeting.title': '會前準備',
  'tasks.sample.meeting.status': '明天 · 上午 10:00',
  'tasks.sample.meeting.meta': '一次性 · 傳送摘要',
  'tasks.sample.meeting.preview': 'meeting_brief.md · 已排隊',
  'tasks.sample.meeting.trigger': '排程 · 一次性',
  'tasks.sample.meeting.pattern': '簡報提示詞',
  'tasks.sample.meeting.runtime': '遠端 · 有界',
  'tasks.sample.meeting.output': '成品 + 訊息',
  'tasks.sample.meeting.artifactMeta': '等待產生',
  'tasks.sample.meeting.body1': '# 會議簡報',
  'tasks.sample.meeting.body2': '議程來源：行事曆事件 + 已連結文件',
  'tasks.sample.meeting.body3': '輸出會包含決策、阻礙事項與問題。',
  'tasks.sample.candidate.title': '候選人追蹤',
  'tasks.sample.candidate.status': '失敗 · 需要處理',
  'tasks.sample.candidate.meta': '驗證已過期',
  'tasks.sample.candidate.preview': '重新連接 Greenhouse 以繼續',
  'tasks.sample.candidate.trigger': '排程 · 每日',
  'tasks.sample.candidate.pattern': '例程 · 應徵者同步',
  'tasks.sample.candidate.runtime': '遠端 · 週期性',
  'tasks.sample.candidate.output': '即時成品 · 表格',
  'tasks.sample.candidate.artifactMeta': '已暫停，直到驗證恢復',
  'tasks.sample.candidate.body1': '# 候選人流程',
  'tasks.sample.candidate.body2': '上次成功同步：2 天前',
  'tasks.sample.candidate.body3': '需要動作：重新連接來源帳戶。',
  ...
  'chat.amrError.authMessage': '需要登入 AMR。請先登入 AMR Cloud，然後重試本次執行。',
  'chat.amrError.balanceMessage': 'AMR Cloud 回報此模型餘額不足。請先為 AMR 錢包儲值，然後重試本次執行。',
  'chat.amrError.authorizeCta': '登入 AMR',
  'chat.amrError.rechargeCta': '儲值 AMR',
  ...
  'designFiles.newFolder': '新增資料夾',
  'designFiles.folderName': '資料夾名稱',
  'designFiles.createFolder': '建立資料夾',
  'designFiles.deleteFolder': '刪除資料夾',
  'designFiles.deleteFolderAria': '刪除資料夾 {path}',
  'designFiles.deleteFolderConfirm': '要刪除資料夾「{path}」嗎？',
  'designFiles.deleteFolderFailed': '無法刪除資料夾「{path}」。',
  ...
  'manualEdit.selectedHtml': '已選元素 HTML',
  ...
  'manualEdit.deleteElementConfirm': '要刪除選取的元素嗎？可使用「復原」還原。',
  'manualEdit.uploadImage': '上傳圖片',
  'manualEdit.uploadingImage': '正在上傳圖片…',
  ...
  'liveArtifact.refresh.buttonTitle': '重新整理此即時成品',
  'liveArtifact.refresh.loadingTitle': '正在載入即時成品…',
  'liveArtifact.refresh.noSourceTitle': '尚無可用的重新整理來源。',
  ...
  'liveArtifact.refresh.failureAction': '請查看「重新整理歷史」，修復來源或權限問題後再試一次。',
  'liveArtifact.refresh.networkFailure': '重新整理請求失敗。請檢查網路連線後再試一次。',
  'liveArtifact.refresh.genericFailure': '重新整理失敗。',
  'liveArtifact.refresh.statusNever': '無法重新整理',
  ...
  'liveArtifact.refresh.statusRunningDescription': '目前正在進行重新整理。',
  'liveArtifact.refresh.statusSucceededDescription': '上次重新整理已成功完成。',
  'liveArtifact.refresh.statusFailedDescription': '上次重新整理嘗試未成功完成。',
  'liveArtifact.refresh.statusReadyDescription': '已設定可重新整理的來源，目前沒有執行中的重新整理。',
  'liveArtifact.refresh.statusNeverDescription': '此即時成品尚無重新整理來源。',
  'liveArtifact.refresh.eventStarted': '已開始',
  'liveArtifact.refresh.eventSucceeded': '已成功',
  'liveArtifact.refresh.eventFailed': '已失敗',
  'liveArtifact.refresh.eventStartedDetail': '重新整理已開始…',
  ...
  'liveArtifact.refresh.debugSummary': '進階偵錯中繼資料',
  'liveArtifact.refresh.debugNote':
    '可能包含連接器 ID、檔案名稱、來源中繼資料和內部成品路徑。',
  ...
  'settings.designSystemsGithubUrl': 'GitHub 地址',
  ...
  'settings.memoryExtractionsClearConfirm': '確定要清空整個抽取歷史嗎？此操作無法復原。',
  ...
  'settings.memoryModelInlineHintByokNeutral': 'Memory 使用與聊天分開的模型；預設沿用目前的聊天模型。',
