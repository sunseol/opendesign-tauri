...
export const th: Dict = {
  ...
  'designFiles.newFolder': 'โฟลเดอร์ใหม่',
  'designFiles.folderName': 'ชื่อโฟลเดอร์',
  'designFiles.createFolder': 'สร้างโฟลเดอร์',
  'designFiles.deleteFolder': 'ลบโฟลเดอร์',
  'designFiles.deleteFolderAria': 'ลบโฟลเดอร์ {path}',
  'designFiles.deleteFolderConfirm': 'ลบโฟลเดอร์ "{path}" หรือไม่',
  'designFiles.deleteFolderFailed': 'ไม่สามารถลบโฟลเดอร์ "{path}" ได้',
  ...
  'settings.apiKeyGetLink': 'รับคีย์ที่ {host} ↗',
  ...
  'preview.unavailableTitle': 'ไม่มีตัวอย่างที่เผยแพร่สำหรับสกิลนี้',
