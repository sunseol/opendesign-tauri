...
function ProseBlock({
  ...
  // through the workspace tab opener. Without this, the desktop shell may
  // open a new context whose relative href can't resolve, and the user lands
  // on the home screen instead of seeing the file preview.
