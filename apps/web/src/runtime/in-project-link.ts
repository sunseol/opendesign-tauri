 ...
 * through to the default browser / desktop-shell link behavior.
 *
 ...
 * default `target="_blank"` they can open outside the current project
 * context and land on the home screen. Routing them through
