...
mirror="${OD_SANDBOX_REPO_MIRROR:-$HOME/.cache/agent-pr-explore/opendesign-tauri.git}"
...
You are reviewing ${BASE_REPO} PR #${PR_NUMBER}, against the live app at ${base_url}.
