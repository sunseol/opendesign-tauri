...
## Introduction
This chart bootstraps an [Open Design Tauri fork](https://github.com/sunseol/opendesign-tauri) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
